...
/*********************************************************/
//DDR ->  CONFIG_CLK_1000_200_166_133
...
#define CONFIG_MMC
//#define CONFIG_SDHCI
//#define CONFIG_S5P_SDHCI   //注释掉,去掉原来的驱动
#define CONFIG_S3C_HSMMC  // added.添加这一行添加上新的移植过来的驱动文件
...
#define PHYS_SDRAM_3		0x0		/* mDDR DMC2 Bank #2 */
#define PHYS_SDRAM_3_SIZE	(0)		/* 128 MB in Bank #2 */
